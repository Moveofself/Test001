...
{
    public class PerformControlLotTrackIn
    {
       ...
       // public MesMessage CurrentMesMessage;
        ...
        public ExecuteResult Execute()
        {
            ...
            try
            {
                CurrentLogViewModel.AppendLineToUI(String.Format((String)Application.Current.FindResource("InfoMessage_TrackInToMes"), ControlLotId), LogLevel.Info);

                TrackInInput trackInInput = new TrackInInput();

                trackInInput.EquipmentId = EquipmentId;
                trackInInput.LotId = ControlLotId;
